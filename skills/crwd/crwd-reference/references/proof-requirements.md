...
| `requires_review_link` | The link to their posted review |
...
- **Two-thirds of live-gig submissions carry a review link**, which the old gig-type list
  didn't mention at all.
- Most online gigs require a review **link** and a **rating**, neither of which appeared in
  the old list.
...
- **Online (`web_based`)** — receipt, order id, review receipt, review link, and rating are
  all common.
...
receipts, screenshots, review links, and UGC links all go here, not into the CRWD app.
