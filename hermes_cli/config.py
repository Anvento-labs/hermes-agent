...
OPTIONAL_ENV_VARS = {
    ...
    "CRWD_ASSET_BASE_URL": {
        "description": "CRWD asset base URL used to build contact avatar URLs from users.profile_pic filenames (Chatwoot enrichment)",
        "prompt": "CRWD asset base URL (e.g. https://cdn.crwd.app/uploads)",
        "url": None,
        "password": False,
        "category": "tool",
        "advanced": True,
    ...
    "CRWD_APP_BASE_URL": {
        "description": "CRWD member web app base URL; crwd_db inlines gig page links into name/gig_name at fetch time (e.g. https://app.crwd.example.com)",
    ...
    "CRWD_ENRICH_TTL_DAYS": {
        "description": "Days before a Chatwoot contact is re-enriched from CRWD MongoDB (default: 30)",
        "prompt": "CRWD enrichment TTL in days",
        "url": None,
        "password": False,
        "category": "tool",
        "advanced": True,
